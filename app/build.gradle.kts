...
android {
    ...
    buildTypes {
        release{
            ...
            resValue("string","app_name","VS Mobile")
        }
        debug{
...
tasks.register("downloadCSServer") {
    doLast {
        downloadFile(
            "../core/main/src/main/assets/cs-aarch64.tgz",
            "https://github.com/ahksoft/vscode-android-server/releases/download/Init/cs-aarch64.tgz",
            "0ee4d23609d2e013be28d822ccccefddc1619dcd508a2976f9bd1809d5c0d57c"
        )
    }
}
...
afterEvaluate {
    android.applicationVariants.all { variant ->
        ...
        variant.javaCompileProvider.dependsOn("downloadCSServer")
        true
    }
}
